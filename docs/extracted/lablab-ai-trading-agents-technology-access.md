...
**Related:** [`lablab-ai-trading-agents-essentials.md`](lablab-ai-trading-agents-essentials.md) — core loop & checklist · [`lablab-ai-trading-agents-rules-research.md`](lablab-ai-trading-agents-rules-research.md) — judging, submission TBA, Surge eligibility (no secrets in repo).
